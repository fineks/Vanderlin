...
/datum/species/elf/dark
	...
	specstats_m = list(STATKEY_STR = -1, STATKEY_PER = -1, STATKEY_INT = 1, STATKEY_CON = -1, STATKEY_END = 2, STATKEY_SPD = 2, STATKEY_LCK = 1)
	specstats_f = list(STATKEY_STR = 2, STATKEY_PER = -1, STATKEY_INT = 0, STATKEY_CON = 2, STATKEY_END = 1, STATKEY_SPD = 1, STATKEY_LCK = 0)
