...
/datum/species/tieberian
	...
	specstats_m = list(STATKEY_STR = 1, STATKEY_PER = 2, STATKEY_INT = 2, STATKEY_CON = 0, STATKEY_END = 0, STATKEY_SPD = 1, STATKEY_LCK = -1)
	specstats_f = list(STATKEY_STR = 0, STATKEY_PER = 3, STATKEY_INT = 1, STATKEY_CON = -1, STATKEY_END = 2, STATKEY_SPD = 2, STATKEY_LCK = 0)
