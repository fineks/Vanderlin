...
/datum/species/harpy
	...
	specstats_m = list(STATKEY_STR = -3, STATKEY_PER = 4, STATKEY_INT = 1, STATKEY_CON = -2, STATKEY_END = 0, STATKEY_SPD = 2, STATKEY_LCK = 0)
	specstats_f = list(STATKEY_STR = -4, STATKEY_PER = 4, STATKEY_INT = 1, STATKEY_CON = -3, STATKEY_END = 0, STATKEY_SPD = 2, STATKEY_LCK = 1)
